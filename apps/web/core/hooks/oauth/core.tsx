...
export const useCoreOAuthConfig = (oauthActionText: string): TOAuthConfigs => {
  ...
  const oAuthOptions: TOAuthOption[] = [
    ...
    },
    {
      ...
      icon: (
        <svg height={18} width={18} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
            d="M32 4L6 18v28l26 14 26-14V18L32 4z"
            fill="#4D9FDB"
          />
          <path
            d="M32 12l-18 10v20l18 10 18-10V22L32 12z"
            fill="#fff"
          />
          <path
            d="M32 20l-10 5.5v11L32 42l10-5.5v-11L32 20z"
            fill="#4D9FDB"
          />
        </svg>
      ),
